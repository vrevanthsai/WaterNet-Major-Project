...
-- Database: `waternet`
--
CREATE DATABASE IF NOT EXISTS `waternet` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `waternet`;
...
--
-- Table structure for table `remote_user_assessing_water_quality`
--

CREATE TABLE IF NOT EXISTS `remote_user_assessing_water_quality` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `RID` varchar(3000) NOT NULL,
  `State` varchar(3000) NOT NULL,
  `District_Name` varchar(3000) NOT NULL,
  `Place_Name` varchar(3000) NOT NULL,
  `ph` varchar(3000) NOT NULL,
  `Hardness` varchar(3000) NOT NULL,
  `Solids` varchar(3000) NOT NULL,
  `Chloramines` varchar(3000) NOT NULL,
  `Sulfate` varchar(3000) NOT NULL,
  `Conductivity` varchar(3000) NOT NULL,
  `Organic_carbon` varchar(3000) NOT NULL,
  `Trihalomethanes` varchar(3000) NOT NULL,
...
--
-- Dumping data for table `remote_user_assessing_water_quality`
--

INSERT INTO `remote_user_assessing_water_quality` (`id`, `RID`, `State`, `District_Name`, `Place_Name`, `ph`, `Hardness`, `Solids`, `Chloramines`, `Sulfate`, `Conductivity`, `Organic_carbon`, `Trihalomethanes`, `Turbidity`, `Prediction`) VALUES
(1, 'AE508CW7ON3EP', 'ANDHRA PRADESH', 'EAST GODAVARI', 'CHINTALURU(0404410028011000)', '5.584086638', '188.3133238', '28748.68774', '7.544868789', '326.6783629', '280.4679159', '8.39973464', '54.91786184', '2.559708228', 'IRRIGATION WATER'),
(2, 'AQX8FF2YCO3J7', 'ANDHRA PRADESH', 'WEST GODAVARI', 'GARUVUPALEM(0506639005021800)', '9.2838', '148.1530614', '15193.41347', '9.046832707', '307.0117926', '563.8047433', '16.56865557', '52.67618503', '6.038184953', 'IRRIGATION WATER'),
(3, 'A32OZFDUK07WLV', 'ASSAM', 'BAKSHA', 'JARTALUK UTTAR SUBA', '7.543931305', '192.2345408', '24227.96114', '7.241343465', '336.1510498', '369.4276991', '18.18887253', '70.58850738', '3.703191306', 'DRINKING WATER'),
(4, 'A1WQ3UGXPT15VI', 'BIHAR', 'KISHANGANJ', 'KHARRAKASHT', '4.814135621', '205.2140411', '17650.40505', '8.121080147', '350.4879387', '414.030709', '10.99941608', '47.40266587', '5.190851805', 'IRRIGATION WATER'),
(5, 'A1PGMT8XLL4FPM', 'ANDHRA PRADESH', 'KURNOOL(13)', 'MADDUR(1318339008010800)', '8.291299006', '211.2170343', '20008.13496', '8.767875035', '275.7673211', '475.9091299', '12.6146689', '66.61298363', '3.424701921', 'DRINKING WATER');
...
(2, 'Manjunath', 'tmksmanju19@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,Rajajinagar', 'Male');
...
(22, 'Naive Bayes', '68.06201550387597'),
(23, 'SVM', '67.13178294573643'),
(24, 'Logistic Regression', '68.21705426356588'),
(25, 'Decision Tree Classifier', '65.58139534883722'),
(26, 'KNeighborsClassifier', '62.48062015503876'),
(27, 'SGD Classifier', '67.13178294573643'),
(28, 'Random Forest Classifier', '65.42635658914729');
...
(14, 'IRRIGATION WATER', '60.0'),
(15, 'DRINKING WATER', '40.0');
